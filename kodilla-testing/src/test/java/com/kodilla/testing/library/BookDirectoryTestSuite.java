...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testListBooksInHandsOfUserWhen0() {
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOfBooks = new ArrayList<Book>();
        LibraryUser user = new LibraryUser("Jan", "Nowak", "78110312547");
    ...
    @Test
    public void testListBooksInHandsOfUserWhen1() {
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOfBooks = new ArrayList<Book>();
        resultListOfBooks.add(new Book("Encyklopedia", "Jan Gutenberg", 1520));
        LibraryUser user = new LibraryUser("Jan", "Nowak", "78110312547");
        when(libraryDatabaseMock.listBooksInHandsOf(user)).thenReturn(resultListOfBooks);
        //When
        List<Book> theListOfBooks = bookLibrary.listBooksInHandsOf(user);
    ...
    @Test
    public void testListBooksInHandsOfUserWhen5() {
        // Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOfBooks = new ArrayList<Book>();
